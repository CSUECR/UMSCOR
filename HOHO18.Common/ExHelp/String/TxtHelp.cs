...
namespace System
{
    ...
    public static class TxtHelp
    {
        ...
        /// <returns></returns>
        public static string ToString(this object src, string format)
        {
        ...
        /// <param name="format"></param>
        /// <returns></returns>
        public static string ToFormat(this object src, string format = "{0}")
        {
            return string.Format(format, src);
        }
        ...
        /// <returns></returns>
        public static bool Eql(this string str, string str2, StringComparison comparison = StringComparison.OrdinalIgnoreCase)
        {
            //"abc".Eql("Abc")==true 
            return str == str2 ||
                str != null && str.Equals(str2, comparison);
        }
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        public static bool IsWhite(this string text)
        {
        ...
        /// <returns></returns>
        public static string LastText(this string str, string tag = "/")
        {
            var index = str.LastIndexOf(tag);
            var result = str.Substring(index + tag.Length);
            return result;
        }
        ...
        /// <param name="tag"></param>
        /// <returns></returns>
        public static string StartText(this string str, string tag = "/")
        {
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        public static string Html(this string str)
        {
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        public static string UrlDe(this string str)
        {
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        public static string SqlStr(this string str)
        {
        ...
        /// <param name="str"></param>
        /// <returns></returns>
        public static string JsStr(this string str)
        {
        ...
        /// <returns></returns>
        public static double?[] SplitNumN(this string str, string chr = ",", bool noIg = false)
        {
            //"1,2,3,4".SplitNumN() == new double?[]{1,2,3,4}
            var txts = str.Split(new[] { chr },
                noIg ?
                    StringSplitOptions.RemoveEmptyEntries :
                    StringSplitOptions.None);
            var nums = txts.Select(txt => txt.ToNumN());
            return nums.ToArray();
        }
        ...
        /// <param name="chr"></param>
        /// <returns></returns>
        public static T[] Split<T>(this string str, string chr = ",", bool noIg = false)
        {
            var txts = str.Split(new[] { chr },
                noIg ?
                    StringSplitOptions.RemoveEmptyEntries :
                    StringSplitOptions.None);
            var nums = txts.Select(txt => txt.ToAs<T>());
        ...
        /// <param name="chr"></param>
        /// <returns></returns>
        public static double[] SplitNum(this string str, string chr = ",", bool noIg = false)
        {
            var nums = str.SplitNumN(chr,noIg);
            return nums.Select(num => num ?? 0d).ToArray();
        }
        ...
        /// <param name="str"></param>
        /// <param name="chr"></param>
        /// <param name="noIg"></param>
        /// <returns></returns>
        public static int?[] SplitIntN(this string str, string chr = ",", bool noIg = false)
        {
            var nums = str.SplitNumN(chr,noIg);
            return nums.Select(num => num != null ? (int)num.Value : (int?)null).ToArray();
        }
        ...
        /// <param name="noIg"></param>
        /// <returns></returns>
        public static int[] SplitInt(this string str, string chr = ",", bool noIg = false)
        {
            var nums = str.SplitIntN(chr, noIg);
            return nums.Select(num => num ?? 0).ToArray();
        }
        ...
        /// <param name="noIg"></param>
        /// <returns></returns>
        public static string Join(this IEnumerable items, string chr = ",", bool noIg = false)
        {
            //new[] { 1, 2, 3, 4 }.Join()=="1,2,3,4";
            var ary = items.Cast<object>().
                Where(item => noIg ||
                    item != null &&
                    !item.ToString().IsWhite());
            var strAry = ary.Select(item => item.ToAs<string>()).ToArray();
            var txt = string.Join(chr, strAry);
            return txt;
        }
        ...
        /// <param name="text"></param>
        /// <returns></returns>
        public static string Pym(this string text)
        {
            string pym = null;
            if (text != null)
            {
        ...
        /// <param name="hz"></param>
        /// <returns></returns>
        private static string GetFirstLetter(string hz)
        {
