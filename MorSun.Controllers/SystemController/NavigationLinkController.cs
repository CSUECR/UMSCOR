...
namespace MorSun.Controllers.CommonController
{
    public class NavigationLinkController : BaseController<wmfNavigationLink>
    {
        ...
        {
            get { return MorSun.Common.Privelege.资源.左侧菜单; }
        }

        private BaseBll<wmfNavigationLink> _navigationLinkBll;

        public BaseBll<wmfNavigationLink> NavigationLinkBll
        {
            get
            {
                _navigationLinkBll = _navigationLinkBll.Load();
                return _navigationLinkBll;
            }
        ...
        protected override string OnEditCK(wmfNavigationLink t)
        {
            ...
            ////通知 添加测试
            //var notice = new wmfNotice();
            //notice.CreateTime = DateTime.Now;
            //notice.IsNew = false;
            //notice.IsRead = false;
            //notice.LinkedId = Guid.NewGuid();
            //notice.NoticeCategoryId = Guid.Parse("158a01f2-9e45-4439-a8a8-10b379c76b49");
            //notice.NoticeContent = "通知内容";
            //notice.NoticeUserId = UserID;
            //notice.OperateContent = "操作内容";
            //notice.RegTime = DateTime.Now;
            //notice.RequestUserid = UserID;
            //var noticeBll = new wmfNoticeBll();
            //noticeBll.createNotice(notice);

            ////通知 更新测试
            //var noticeBll = new wmfNoticeBll();
            //noticeBll.updateNoticeIsRead(Guid.Parse("922EB767-3398-4606-9B40-7E80795D9433"));
        ...
        public string GenerationMenu()
        {
            if (MorSun.Controllers.BasisController.havePrivilege(ResourceId, MorSun.Common.Privelege.操作.生成))
            {
                ...
                var ReList = new ResourcesVModel().All.OrderBy(t => t.Sort);
