...
namespace MorSun.Controllers.Quartz
{
    public class CheckingJob4:IJob
    {
        ...
        private static OnlineQAUserCache GenerateQAUserCache()
        {
            ...
            LogHelper.Write((acQADdt.ToShortTimeString() + "自动更新用户缓存时未处理的问题数量" + nonACQAD.Count().ToString()), LogHelper.LogMessageType.Debug);
            ...
            LogHelper.Write("自动更新用户缓存结束", LogHelper.LogMessageType.Debug);
        ...
        private void SaveToCacheByDependency(string cacheKey, object cacheObject, CacheDependency dependency)
        {
        ...
        private void SetOlineQAUserCache(OnlineQAUserCache qaCache)
        {
