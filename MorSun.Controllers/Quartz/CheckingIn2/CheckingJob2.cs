...
{
    public class CheckingJob2 : IJob
    {
        ...
        /// <returns></returns>
        private string GetGeneralLogData(Guid id, bool clearData)
        {
            string msg = "";
            ...
            //var kqRecordCount = int.Parse(HOHO18.Common.Web.webConfigHelp.GetWebConfigValue("KqRecordCount"));
            ...
            if (axCZKEM.ReadGeneralLogData(iMachineNumber))//read all the attendance records to the memory
            {
                           ...
                           out idwInOutMode, out idwYear, out idwMonth, out idwDay, out idwHour, out idwMinute, out idwSecond, ref idwWorkcode))//get records from the memory
                {
                    ...
                    //if (iValue >= kqRecordCount)
                    //{
                    //    recordList.Add(new kqRecord() { CId = CId, RecordTime = RTime });
                ...
                //    FileObj.FolderCreate(new BasisController().getServerPath("/UploadFile/kqRecord/") + id);
                //    var fileName = DateTime.Now.ToString("yyyy-MM-dd") + ".xls";
                //    var oldFileName = fileName;
                //    fileName = new BasisController().getServerPath("/UploadFile/kqRecord/") + id + "/" + fileName;
        ...
        public virtual void Execute(IJobExecutionContext context)
        {
            ...
            string id = "afb18463-aa69-4657-8618-e56d2b46e548";// "f1547562-dda5-4fba-9d53-4ad44a898d42";//考勤机ID
            string msg = "";//返回消息
